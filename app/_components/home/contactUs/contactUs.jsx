...
const ContactUsForm = () => {
  ...
  const confirmSave = () => {
    ...
    console.log('Updated Contact Us Section Data:', dataToSubmit);
        ...
        >
          <div className="space-y-6">
            ...
            <div>
              ...
              <div className="space-y-4">
                {[
                  { field: 'nameLabel', label: 'Name Label', placeholder: 'Enter label for name field' },
                  { field: 'emailLabel', label: 'Email Label', placeholder: 'Enter label for email field' },
                  { field: 'phoneLabel', label: 'Phone Label', placeholder: 'Enter label for phone field' },
                  { field: 'messageLabel', label: 'Message Label', placeholder: 'Enter label for message field' },
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full bg-zinc-800 rounded-lg p-3 text-white transition-all duration-200"
                    rows={4}
                    placeholder="Enter description for contact information"
                  />
                </div>
                <div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                        <div>
                          ...
                          <input
                            ...
                            className="w-full bg-zinc-800 rounded-lg p-3 text-white transition-all duration-200"
                            placeholder="Enter title (e.g., Phone Number)"
                          />
                        </div>
                        <div>
                          ...
                          <input
                            ...
                            className="w-full bg-zinc-800 rounded-lg p-3 text-white transition-all duration-200"
                            placeholder="Enter value (e.g., +1 234 567 890)"
                          />
                        </div>
                      </div>
                    </div>
